<template>
  ...
  >
    ...
    >
      <h1 class="text-2xl font-bold mb-6 animate-slide-in-top">Log in</h1>
      <form @submit.prevent="onSubmit" class="space-y-4">
        ...
        <button class="btn-primary w-full hover-lift hover-glow">Log in</button>
        <p class="text-sm text-gray-400">
          Don't have an account?
          <RouterLink class="text-orange-400 hover:text-orange-300" to="/signup"
            >Sign up</RouterLink
          >
        </p>
      </form>
...
async function onSubmit() {
  try {
    ...
    toast.value = e?.message || "Login failed";
